...
[**qspray** package](https://github.com/stla/qspray). Here is how you can 
...
the package: functions `JackPolCPP`, `SchurPolCPP`, and `ZonalPolCPP`. 
...
Jack parameter in its coefficients, thanks to the `JackSymPol` function:
...
[**symbolicQspray** package](https://github.com/stla/symbolicQspray).
...
the Jack parameter is denoted by `a` and the variables are denoted by `X`, `Y`, `Z` if there are at most three variables, otherwise they are denoted by `X1`, 
