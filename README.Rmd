...
`Schur`, which directly evaluate the polynomial, and this is much more 
efficient than resorting to a `qspray` polynomial.
...
always true for any Jack polynomial (for any J-Jack polynomial, I should say). 
This fact is established and it is not obvious.
